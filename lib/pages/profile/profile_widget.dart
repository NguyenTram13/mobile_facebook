                              ...
                              Container(
                                ...
                                child: Stack(
                                  children: [
                                    Align(
                                      alignment:
                                          AlignmentDirectional(0.00, -7.39),
                                      child: Container(
                                        width:
                                                                ...
                                                                if (_model
                                                                  ...
                                                                  FFButtonWidget(
                                                                    onPressed:
                                                                      ...
                                                                      _model.apiResult6mq = await SocialGroup
                                                                          .acceptFriendCall
                                                                          .call(
                                                                        id: getJsonField(
                                                                          _model
                                                                      ...
                                                                      if ((_model
                                                                              ...
                                                                              ?.succeeded ??
                                                                          true)) {
                                                                        _model.apiResultpoi = await SocialGroup
                                                                        ...
                                                                        if ((_model.apiResultpoi?.succeeded ??
                                                                            true)) {
                                                                          setState(
                                                                              () {
                                                                            FFAppState().resRequestFriend =
                                                                                (_model.apiResultpoi?.jsonBody ?? '').toList().cast<dynamic>();
                                                                          });
                                                                        }
                                                                        _model.apiResultcas = await SocialGroup
                                                                            .getFriendCall
                                                                            .call(
                                                                          idUser:
                                                                              getJsonField(
                                                                        ...
                                                                        if ((_model.apiResultcas?.succeeded ??
                                                                            true)) {
                                                                          setState(
                                                                              () {
                                                                            FFAppState().listFriendUserOnline =
                                                                                (_model.apiResultcas?.jsonBody ?? '').toList().cast<dynamic>();
                                                                          });
                                                                        }
                                                                      }
                                                                ...
                                                                if (_model
                                                                  ...
                                                                  FFButtonWidget(
                                                                    onPressed:
                                                                      ...
                                                                      _model.apiResult14l = await SocialGroup
                                                                          .addFriendCall
                                                                          .call(
                                                                        accessToken:
                                                                            FFAppState().accessToken,
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Column(
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                                                                            children: [
                                                                              if (FFAppState().friendProfile.length > 0)
                                                                                Padding(
                                                                              ...
                                                                              if (FFAppState().friendProfile.length < 1)
                                                                                Container(
                                                                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                                                                  decoration: BoxDecoration(
