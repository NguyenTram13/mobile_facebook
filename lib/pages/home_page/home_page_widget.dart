                            ...
                            children: [
                              Flexible(
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if (FFAppState().pageHomeSelect == 'home')
                                      Container(
                                        width:
                                            MediaQuery.sizeOf(context).width *
                                                1.0,
                                    ...
                                    if (FFAppState().pageHomeSelect == 'friend')
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            12.0, 12.0, 12.0, 12.0),
                                        child: Container(
                                    ...
                                    if (FFAppState().pageHomeSelect == 'noti')
                                      // Container(
                                      //   width: 100.0,
                                      //   height: 100.0,
                                      //   decoration: BoxDecoration(
                                      ...
                                      //                                   onPressed:
                                      //                                       () async {
                                      //                                     _model.apiResult3ay = await SocialGroup
                                      //                                         .readAllNotiCall
                                      //                                         .call(
                                      //                                       userId:
                                      //                                           FFAppState().idUser,
                                      ...
                                      //                                     );
                                      //                                     if ((_model.apiResult3ay?.succeeded ??
                                      //                                         true)) {
                                      //                                       _model.apiResult6a0 =
                                      ...
                                      //                                         accessToken: FFAppState().accessToken,
                                      //                                       );
                                      //                                       if ((_model.apiResult6a0?.succeeded ??
                                      //                                           true)) {
                                      //                                         setState(() {
