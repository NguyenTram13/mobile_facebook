                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          if ((_model.apiResult8v7Copy?.succeeded ?? true)) {
                            setState(() {
                              FFAppState().resPostHome =
                          ...
                          if ((_model.apiResulttazCopy?.succeeded ?? true)) {
                            setState(() {
                              FFAppState().resProfile =
                                                                        ...
                                                                        return SingleChildScrollView(
                                                                          child:
                                                                            ...
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                                                                            children:
                                                                                List.generate(noti.length, (notiIndex) {
